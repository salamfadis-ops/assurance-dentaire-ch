...
const journey = [
  {
    ...
    description: "Le parcours s’adapte à un adulte, un enfant ou toute la famille. Vous avancez à votre rythme et reprenez là où vous vous êtes arrêté.",
    metric: "≈ 2 min",
  ...
  },
  {
    ...
    description: "Couverture, prévention, anticipation, budget et documentation : chaque dimension est visible et reliée à une action concrète.",
    metric: "5 axes",
  ...
  },
  {
    ...
    description: "Votre synthèse PDF rassemble le besoin estimé, les points de vigilance et les prochaines vérifications à effectuer avant de choisir.",
    metric: "1 PDF",
